...
export default function ConstructorCreate({ world, countries }: Props) {
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        post(worldsConstructors.store(world.id).url);
    }
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <h1 className="text-2xl font-semibold">New Constructor</h1>
